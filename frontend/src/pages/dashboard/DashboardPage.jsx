    ...
    <div className={`flex gap-6 ${selectedInvoice ? 'mr-80' : ''}`}>
      <div className="flex-1 space-y-6">
        ...
        <Card className="p-0 overflow-hidden">
          <div className="px-6 py-4 border-b border-[color:var(--border)] flex items-center justify-between gap-3 flex-wrap">
          ...
          {loading ? (
            ...
            <div className="px-6 py-8 text-sm text-[var(--text-secondary)]">No invoices match your filters.</div>
          ) : (
